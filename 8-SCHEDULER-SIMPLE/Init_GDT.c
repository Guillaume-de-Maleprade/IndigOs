...
void Intialisation_Descripteurs_Noyau() {
    T_DESCRIPTEUR_SEGMENT* L_Descripteurs_Segment = (T_DESCRIPTEUR_SEGMENT*) ADRESSE_BASE_DESCRIPTEUR_SEGMENT;
...
void Initialisation_GDT() {
    ...
    Info_GDT.Base = ADRESSE_BASE_DESCRIPTEUR_SEGMENT;
    Info_GDT.Limite = LIMITE_DESCRIPTEURS_SEGMENT * sizeof (T_DESCRIPTEUR_SEGMENT);
