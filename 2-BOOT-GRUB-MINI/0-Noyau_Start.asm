...
;-------------------------------------------------------------------------------
        ...
        dd GRUB_CHECKSUM
Debut:
    push ebx    ; puisque une demande d'info mémoire a été demandée,
                ; l’adresse de la structure est envoyée dans EBX.
                ; on empile EBX afin de passer en paramètre l'adresse de la structure
