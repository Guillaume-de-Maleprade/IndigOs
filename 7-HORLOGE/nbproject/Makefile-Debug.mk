...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/noyau.jlv.exe: ${OBJECTFILES}
	...
	i586-pc-elf-ld -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/noyau.jlv ${OBJECTFILES} ${LDLIBSOPTIONS} -Ttext=0x100000 --entry=_start --oformat i586-pc-elf -Tdata=0x200000 -Map=Noyau.map
...
${OBJECTDIR}/CALLBACK_EXCEPTION.o: CALLBACK_EXCEPTION.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CALLBACK_EXCEPTION.o CALLBACK_EXCEPTION.c

${OBJECTDIR}/CALLBACK_IRQ.o: CALLBACK_IRQ.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CALLBACK_IRQ.o CALLBACK_IRQ.c

${OBJECTDIR}/DELAY.o: DELAY.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DELAY.o DELAY.c

${OBJECTDIR}/Descripteurs.o: Descripteurs.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Descripteurs.o Descripteurs.c

${OBJECTDIR}/EXCEPTION.o: EXCEPTION.asm
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -o ${OBJECTDIR}/EXCEPTION.o EXCEPTION.asm

${OBJECTDIR}/Ecran.o: Ecran.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ecran.o Ecran.c

${OBJECTDIR}/HARD_8042_Clavier.o: HARD_8042_Clavier.asm
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -o ${OBJECTDIR}/HARD_8042_Clavier.o HARD_8042_Clavier.asm

${OBJECTDIR}/HARD_8253_Timer.o: HARD_8253_Timer.asm
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -o ${OBJECTDIR}/HARD_8253_Timer.o HARD_8253_Timer.asm

${OBJECTDIR}/INIT_IDT.o: INIT_IDT.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INIT_IDT.o INIT_IDT.c

${OBJECTDIR}/IRQ.o: IRQ.asm
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -o ${OBJECTDIR}/IRQ.o IRQ.asm

${OBJECTDIR}/Init_GDT.o: Init_GDT.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Init_GDT.o Init_GDT.c

${OBJECTDIR}/Outils.o: Outils.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Outils.o Outils.c

${OBJECTDIR}/PIC_8259A.o: PIC_8259A.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PIC_8259A.o PIC_8259A.c
